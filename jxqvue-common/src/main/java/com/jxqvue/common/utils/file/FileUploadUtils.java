package com.jxqvue.common.utils.file;
...
import com.jxqvue.common.exception.file.FileNameLengthLimitExceededException;
import com.jxqvue.common.exception.file.FileSizeLimitExceededException;
import com.jxqvue.common.exception.file.InvalidExtensionException;
...
import com.jxqvue.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = JxqVueConfig.getProfile();
    ...
    {
        int dirLastIndex = JxqVueConfig.getProfile().length() + 1;
